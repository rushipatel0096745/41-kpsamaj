...
$validation = [
    ...
    'dob'  => ['required' => true],
    'course_board_name'  => ['required' => true],
    'type_of_result'  => ['required' => true],
    'university_type' => ['required' => true],
    'spi_cpi_cgpa' => ['required' => true],
    'total_marks' => ['required' => true],
    'obtained_marks' => ['required' => true],
    'mobile'=> ['numeric' => true, 'length' => 10],
    'upload_marksheet' => ['allowed' => ['jpg', 'jpeg', 'png']],
    'upload_leaving_certificate' => ['allowed' => ['jpg', 'jpeg', 'png']],
    'upload_candidate_photo' => ['allowed' => ['jpg', 'jpeg', 'png']],
    'i_agree' => ['required' => true]
];

$result = dynamicInsert("form_tejasvi_tarla", $data, $file, $baseurl, $validation);
