...
$validation = [
    ...
    'native_id'  => ['required' => true],
    'shakhe_id'  => ['required' => true],
    'surname'  => ['required' => true],
    'name'  => ['required' => true],
    'father_name'  => ['required' => true],
    'gender'  => ['required' => true],
    'email' => ['email' => true],
    'upload_photo' => ['allowed' => ['jpg', 'jpeg', 'png']],
    'mobile_number'=> ['numeric' => true, 'length' => 10]
];

$result = dynamicInsert("form_personal_Information", $data, $file, $baseurl, $validation);
...
function dynamicInsert($table, $formData, $filesData, $baseurl, $validation = []) {
    ...
    if ($save > 0) {
        ...
        $query = "SELECT * FROM form_personal_Information WHERE id = '".$formData['id']."'";
