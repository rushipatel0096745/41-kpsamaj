...
$validation = [
    ...
    //'mobile'=> ['required' => true, 'numeric' => true, 'length' => 10],
    'file' => ['required' => true, 'file' => true]
    //'profile_image' => ['required' => true, 'allowed' => ['jpg', 'jpeg', 'png']]
];

$result = dynamicInsert("test_form", $data, $file, $baseurl, $validation);
