...
$validation = [
    ...
    'deceased_name'  => ['required' => true],
    'deceased_native'  => ['required' => true],
    'deceased_shakhe'  => ['required' => true],
    'besna_day' => ['required' => true],
    'date_of_demise' => ['required' => true],
    'besna_time_from' => ['required' => true],
    'besna_time_to' => ['required' => true],
    'besna_date' => ['required' => true],
    'besna_location' => ['required' => true],
    'deceased_photo'   => ['allowed'  => ['jpg', 'jpeg', 'png', 'webp']]
];

$result = dynamicInsert("form_besana_posters", $data, $file, $baseurl, $validation);
echo json_encode($result);


function dynamicInsert($table, $formData, $filesData, $baseurl, $validation = []) {
