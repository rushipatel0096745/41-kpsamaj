...
$validation = [
    ...
    'maternal_village'  => ['required' => true],
    'blood_group'  => ['required' => true],
    'foundation_no'  => ['required' => true],
    'samaj_no'  => ['required' => true],
    'interested_donate_blood'  => ['required' => true],
    'joined_mandal'  => ['required' => true],
    'are_you_disabled' => ['required' => true],
    'intrested_matrimonial_events' => ['required' => true]
];

$result = dynamicInsert("form_other_details", $data, $file, $baseurl, $validation);
